#!/usr/bin/env python3
"""tech-review 구현 문서에 남은 오래된 task 지시문 노드를 archive-first로 정리한다."""
...
SOURCE_RULE = "source LIKE 'obsidian:%03_tech-review%impl%.md%'"
...
TASKISH_PATTERNS = (
    ...
    re.compile(r"```(bash|tsx|html|yaml|typescript|javascript|liquid)", re.I),
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="archive stale tech-review implementation task nodes")
